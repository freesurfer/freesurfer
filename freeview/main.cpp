...
int main(int argc, char *argv[])
{
  ...
  CmdLineEntry cmdLineDesc[] =
  {
    ...
    CmdLineEntry( CMD_LINE_OPTION, "tv", "track_volume", "<FILE>...", "Load one or more track volumes.", 1, 1000 ),
    ...
    CmdLineEntry( CMD_LINE_OPTION, "t", "track", "<FILE>...", "Load one or more track files.", 1, 1000 ),
