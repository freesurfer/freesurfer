...
static const char qt_meta_stringdata_MainApplication[] = {
    "MainApplication\0\0n\0GlobalProgress(int)\0"
    "EmitProgress(int)\0"
};

const QMetaObject MainApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_MainApplication,
      qt_meta_data_MainApplication, 0 }
};
...
int MainApplication::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: GlobalProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: EmitProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void MainApplication::GlobalProgress(int _t1)
{
