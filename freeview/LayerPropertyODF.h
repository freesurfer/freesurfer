...
public:
  ...
  int GetOdfSkip() { return m_nOdfSkip; }

  int GetOdfInversion() { return m_nOdfInversion; }

  double GetOdfScale() { return m_dOdfScale; }

  int GetOdfColorCode() { return m_nOdfColorCode; }
