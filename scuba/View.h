...
class View : public FrameView {
 ...
 public:
  ...
  View( std::string iID );ok 95 north to exit 60 get off the exit take left at light, first reall
road on the left across from black death motorcycles. down a few houses on
left car indriveway, key is in the hiding place.
