...
static char vcid[] = "$Id: mris_register.c,v 1.16 2003/04/17 18:46:35 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_register.c,v 1.16 2003/04/17 18:46:35 kteich Exp $");
