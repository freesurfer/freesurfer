...
get_option(int argc, char *argv[])
{
  ...
  case 'A':
    ...
    nargs = 1 ;
    fprintf(stderr, "logging cutting plane coordinates to %s...\n", argv[2]) ;
    fprintf(alog_fp,"# This file contains the column, row, slice (CRS) and talirach XYZ (TAL)\n");
    fprintf(alog_fp,"# of the cutting planes for the corpus callosum (CC) and pons\n");
