...
static char vcid[] = "$Id: mris_segment_vals.c,v 1.2 2003/04/17 18:58:35 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_segment_vals.c,v 1.2 2003/04/17 18:58:35 kteich Exp $");
