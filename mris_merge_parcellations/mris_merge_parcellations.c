...
static char vcid[] = 
"$Id: mris_merge_parcellations.c,v 1.1 2009/04/24 17:55:26 fischl Exp $";
...
{
  char          **av, *parc1, *parc2, *oname, surf_name[STRLEN], path[STRLEN], *hemi, fname[STRLEN] ;
  int           ac, nargs, msec, a1, a2 ;
  LABEL         *area1, *area2 ;
  MRI_SURFACE   *mris ;
  struct timeb  then ;
