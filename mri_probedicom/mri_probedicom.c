...
static char vcid[] = "$Id: mri_probedicom.c,v 1.15.2.2 2008/05/22 20:20:57 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_probedicom.c,v 1.15.2.2 2008/05/22 20:20:57 greve Exp $", "$Name:  $");
