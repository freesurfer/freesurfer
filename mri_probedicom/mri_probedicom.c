...
static char vcid[] = "$Id: mri_probedicom.c,v 1.17 2007/10/19 03:51:58 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_probedicom.c,v 1.17 2007/10/19 03:51:58 greve Exp $", "$Name:  $");
