...
static char vcid[] = "$Id: mri_probedicom.c,v 1.16 2007/08/30 19:57:45 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_probedicom.c,v 1.16 2007/08/30 19:57:45 greve Exp $", "$Name:  $");
