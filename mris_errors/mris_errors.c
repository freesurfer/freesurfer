...
static char vcid[]="$Id: mris_errors.c,v 1.10 2006/12/29 02:09:10 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_errors.c,v 1.10 2006/12/29 02:09:10 nicks Exp $", "$Name:  $");
