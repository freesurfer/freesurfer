/*
  ...
  $Id: mri_seghead.c,v 1.1 2003/04/28 17:14:40 greve Exp $
*/
...
static char vcid[] = "$Id: mri_seghead.c,v 1.1 2003/04/28 17:14:40 greve Exp $";
char *Progname = NULL;
int debug = 0;
char *subjid;
