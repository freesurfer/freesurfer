...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_ms_EM_with_atlas.c,v 1.3 2006/08/10 21:22:40 nicks Exp $", "$Name:  $");
...
# else
  ...
  if(nvolumes_total == 2 && num_classes == 4){
    ...
    mean1 = 0; std1 = 0; denom1 = 0;
    mean2 = 0; std2 = 0; denom2 = 0;
    for(z=0; z < depth; z++)
      for(y=0; y< height; y++)
	for(x=0; x < width; x++) {
	  if(MRIvox(mri_mask,x,y,z) == 0)
