...
static char vcid[] = "$Id: mris_reverse.c,v 1.4 2003/04/17 18:55:07 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_reverse.c,v 1.4 2003/04/17 18:55:07 kteich Exp $");
