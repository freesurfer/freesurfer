...
static char vcid[] = "$Id: mris_make_surfaces.c,v 1.70.2.4 2006/07/15 04:24:59 nicks Exp $";
...
main(int argc, char *argv[])
{
  ...
  make_cmd_version_string (argc, argv, "$Id: mris_make_surfaces.c,v 1.70.2.4 2006/07/15 04:24:59 nicks Exp $", "$Name:  $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv, "$Id: mris_make_surfaces.c,v 1.70.2.4 2006/07/15 04:24:59 nicks Exp $", "$Name:  $");
