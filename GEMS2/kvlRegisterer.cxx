...
::StartRegistration()
{
  ...
  if(m_ModeIsSSD) 
    {
      SSDmetricType::Pointer aux = SSDmetricType::New();   
      // aux->SetNumberOfSpatialSamples( m_NumberOfSamples ); 
      metric = aux;    
    }
  else
    {
      MImetricType::Pointer aux = MImetricType::New(); 
      aux->SetNumberOfHistogramBins( m_NumberOfBins ); 
      aux->SetNumberOfSpatialSamples( m_NumberOfSamples );
      metric = aux;
    }
