...
class GetConjugateGradientOptimizer : public MatlabRunner
{
public:
  /** Smart pointer typedef support. */
  typedef GetConjugateGradientOptimizer         Self;
  ...
  itkTypeMacro( GetConjugateGradientOptimizer, itk::Object );
  ...
  virtual void Run( int nlhs, mxArray* plhs[],
    ...
    AtlasMeshDeformationConjugateGradientOptimizer::Pointer  optimizer = AtlasMeshDeformationConjugateGradientOptimizer::New();
...
protected:
  GetConjugateGradientOptimizer() {};
  virtual ~GetConjugateGradientOptimizer() {};


  GetConjugateGradientOptimizer(const Self&); //purposely not implemented
