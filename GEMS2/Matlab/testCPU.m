...
kvlSetMaximumNumberOfThreads( 4 );
...
meshCollectionFileName = '/home/koen/software/mergedCodeEugenioAndOula/GEMSapplications/wholeBrain/CurrentMeshCollection30New.txt.gz';
compressionLookupTableFileName = '/home/koen/software/mergedCodeEugenioAndOula/GEMSapplications/wholeBrain/namedCompressionLookupTable.txt'; % Look-up table belonging to the atlas (see below)
%  transformedTemplateFileName = './exampleData/AP/mni305_masked_autoCropped_coregistered.mgz';
transformedTemplateFileName = '/home/koen/software/mergedCodeEugenioAndOula/GEMSapplications/wholeBrain/./exampleData/1484/mni305_masked_autoCropped_coregistered.mgz';
imageFileNames = cell(0,0);
%  imageFileNames{1} = './exampleData/AP/orig.mgz';
imageFileNames{1} = '/home/koen/software/mergedCodeEugenioAndOula/GEMSapplications/wholeBrain/./exampleData/1484/orig.mgz';
...
%  figure
%  imshow( ( tmp1 - min( tmp1(:) ) ) / ( max( tmp1(:) ) - min( tmp1(:) ) ) )
%  figure
%  imshow( ( tmp2 - min( tmp2(:) ) ) / ( max( tmp2(:) ) - min( tmp2(:) ) ) )
...
maxNuberOfIterationPerMultiResolutionLevel(1) = 5;
maxNuberOfIterationPerMultiResolutionLevel(2) = 20;
...
for multiResolutionLevel = 1 : numberOfMultiResolutionLevels
    ...
    for iterationNumber = 1 : maximumNumberOfIterations
        ...
        positionUpdatingMaximumNumberOfIterations = 500;%300;
