...
///////////////////////
// Version with multiple channels
//////////////////////
/*
#ifndef __kvlAtlasMeshHamiltonianPositionSampler_h
#define __kvlAtlasMeshHamiltonianPositionSampler_h
...
public :
  ...
  std::vector< vnl_vector<float> >&  GetMeans() const
  {
    return m_Means;
  }
  ...
  std::vector< vnl_matrix<float> >&  GetPrecisions() const
  {
    return m_Precisions;
  }
...
private :
  ...
  std::vector< vnl_vector<float> >  m_Variances;
