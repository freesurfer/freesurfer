...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_deform.c,v 1.21 2010/02/10 22:56:28 krish Exp $", "$Name:  $");
...
{
  int    index, i, j ;
  double valley_val, peak_val=0, previous_peak_val=0 ;
