...
main(int argc, char *argv[]) {
  ...
  (argc, argv,
   "$Id: mris_ca_deform.c,v 1.1 2009/12/03 22:25:22 fischl Exp $",
   "$Name:  $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv, "$Id: mris_ca_deform.c,v 1.1 2009/12/03 22:25:22 fischl Exp $", "$Name:  $");
