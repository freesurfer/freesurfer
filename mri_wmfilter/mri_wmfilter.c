...
static char vcid[] = "$Id: mri_wmfilter.c,v 1.17 2006/12/29 02:09:10 nicks Exp $";
...
main(int argc,char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_wmfilter.c,v 1.17 2006/12/29 02:09:10 nicks Exp $", "$Name:  $");
