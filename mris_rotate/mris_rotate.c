...
static char vcid[] = "$Id: mris_rotate.c,v 1.3 2003/04/17 18:57:32 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_rotate.c,v 1.3 2003/04/17 18:57:32 kteich Exp $");
