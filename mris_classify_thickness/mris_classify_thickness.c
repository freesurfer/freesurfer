...
static char vcid[] = "$Id: mris_classify_thickness.c,v 1.7 2006/12/29 02:09:10 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  *vbest_pvalues, current_min_label_area, current_fthresh ;
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_classify_thickness.c,v 1.7 2006/12/29 02:09:10 nicks Exp $", "$Name:  $");
