...
static char vcid[] =
  "$Id: histo_register_block.c,v 1.8 2006/12/29 02:08:58 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: histo_register_block.c,v 1.8 2006/12/29 02:08:58 nicks Exp $", "$Name:  $");
