...
static char vcid[] =
  "$Id: histo_compute_joint_density.c,v 1.3 2006/12/29 02:08:58 nicks Exp $";
char *Progname ;
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: histo_compute_joint_density.c,v 1.3 2006/12/29 02:08:58 nicks Exp $", "$Name:  $");
