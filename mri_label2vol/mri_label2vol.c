...
static char vcid[] = "$Id: mri_label2vol.c,v 1.38 2011/09/30 15:17:59 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  make_cmd_version_string (argc, argv,
                           "$Id: mri_label2vol.c,v 1.38 2011/09/30 15:17:59 greve Exp $", "$Name:  $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv,
                                 "$Id: mri_label2vol.c,v 1.38 2011/09/30 15:17:59 greve Exp $", "$Name:  $");
