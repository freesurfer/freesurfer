...
/*
  ...
  $Id: mri_label2vol.c,v 1.29 2009/06/09 16:21:49 greve Exp $
*/
...
static char vcid[] = "$Id: mri_label2vol.c,v 1.29 2009/06/09 16:21:49 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  make_cmd_version_string (argc, argv,
                           "$Id: mri_label2vol.c,v 1.29 2009/06/09 16:21:49 greve Exp $", "$Name:  $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv,
                                 "$Id: mri_label2vol.c,v 1.29 2009/06/09 16:21:49 greve Exp $", "$Name:  $");
