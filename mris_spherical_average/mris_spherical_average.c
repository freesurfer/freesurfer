...
main(int argc, char *argv[])
{
  ...
  make_cmd_version_string (argc, argv, "$Id: mris_spherical_average.c,v 1.30.2.1 2011/04/27 13:51:40 nicks Exp $", "$Name:  $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv, "$Id: mris_spherical_average.c,v 1.30.2.1 2011/04/27 13:51:40 nicks Exp $", "$Name:  $");
