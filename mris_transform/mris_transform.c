...
static char vcid[] = "$Id: mris_transform.c,v 1.2 2003/04/17 19:06:24 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_transform.c,v 1.2 2003/04/17 19:06:24 kteich Exp $");
