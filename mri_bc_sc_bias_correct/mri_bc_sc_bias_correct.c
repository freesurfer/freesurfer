...
static char vcid[] =
  "$Id: mri_bc_sc_bias_correct.c,v 1.4 2006/12/29 02:09:04 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  *mri_smooth_bias, *mri_tmp, *mri_out  ;
  ...
  Progname = argv[0] ;
  nargs = handle_version_option (argc, argv, "$Id: mri_bc_sc_bias_correct.c,v 1.4 2006/12/29 02:09:04 nicks Exp $", "$Name:  $");
