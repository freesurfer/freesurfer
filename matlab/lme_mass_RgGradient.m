function gr = lme_mass_RgGradient(X,Zcols,W,invH,L,phi,re,ni,GD,invG)
% gr = lme_mass_RgGradient(X,Zcols,W,invH,L,phi,re,ni,GD,invG)
% 
...
% gr: Gradient vector.
%
% $Revision: 1.2.2.2 $  $Date: 2013/01/22 20:59:09 $
