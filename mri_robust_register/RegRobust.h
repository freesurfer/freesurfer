...
public:
  RegRobust():Registration(),sat(-1),wlimit(0.175),mri_weights(NULL), mri_hweights(NULL),mri_indexing(NULL){};
  virtual ~RegRobust();
...
*/
template < class T > 
void RegRobust::iterativeRegistrationHelper( int nmax,double epsit, MRI * mriS, MRI* mriT, const vnl_matrix < double >& m, double scaleinit)
{
