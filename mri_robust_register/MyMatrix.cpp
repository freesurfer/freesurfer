...
//    of [m/m] Pade approximant, where m = 3,5,7,9,13.
{
  ...
  switch  ( m )
  {
      ...
      case 7 :
			{
        double d[] = {17297280.0, 8648640.0, 1995840.0, 277200.0, 25200.0, 1512.0, 56.0, 1.0};
				c = d;
		  	break ; 
			}
      case 9 :
			{
        double d[] = {17643225600.0, 8821612800.0, 2075673600.0, 302702400.0, 30270240.0, 
      ...
      case 13 :
			{
        double d[] = {64764752532480000.0, 32382376266240000.0, 7771770303897600.0, 
