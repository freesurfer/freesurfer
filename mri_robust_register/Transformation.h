...
public:
  ...
  virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const =0;

  //! Set the parameters from double std vector
  void setParameters(const std::vector < double > &p) {assert(p.size() >= getDOF()); assert(parameters.size() == getDOF()); for (unsigned int i=0;i<getDOF();i++) parameters[i]=p[i];};
  //! Set the parameters from float vnl vector
  void setParameters(const vnl_vector < float >   &v) {assert(v.size() >= getDOF()); assert(parameters.size() == getDOF()); for (unsigned int i=0;i<getDOF();i++) parameters[i]=v[i];};
  //! Set the parameters from double vnl vector
  void setParameters(const vnl_vector < double >  &v) {assert(v.size() >= getDOF()); assert(parameters.size() == getDOF()); parameters = v; parameters.set_size(getDOF());};
...
{
public:
  Transform2dAffine() { parameters.set_size(getDOF()); setIdentity();};
  ...
  inline virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const
  {
...
{ // M = T*shear*Scale*Rot
public:
  Transform2dAffine2() { parameters.set_size(getDOF()); setIdentity();};
  ...
  virtual vnl_matrix_fixed < double, 4, 4 > getMatrix() const
  {
    ...
    smat[0][0] = parameters[3]; smat[1][1] = parameters[4]; smat[2][2] = 1;
    //Shear
  ...
  inline virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const
  {
    std::cerr << "Gradient for affine 2d (second type) not implemented!" << std::endl;
    exit(1);
    vnl_vector < double > ret(6);
    ret[0] = fx;
    ret[1] = fx;
...
{
public:
  Transform2dIsoscale() { parameters.set_size(getDOF()); setIdentity();};
...
public:
  Transform2dIsoscale2() { parameters.set_size(getDOF()); setIdentity();};
  ...
  inline virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const
  {
    std::cerr << "Gradient for isoscale 2d (second type) not implemented!" << std::endl;
    exit(1);
    vnl_vector < double > ret(4);
    ret[0] =  fx;
    ret[1] =  fy;
...
{// rigid  tx, ty, r
public:
  Transform2dRigid() { parameters.set_size(getDOF()); setIdentity();};
...
public:
  Transform2dRigid2() { parameters.set_size(getDOF()); setIdentity();};
  ...
  inline virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const
  {
    std::cerr << "Gradient for rigid 2d (second type) not implemented!" << std::endl;
    exit(1);
    vnl_vector < double > ret(3);
    ret[0] =  fx;
    ret[1] =  fy;
...
{
public:
  Transform2dTranslate() { parameters.set_size(getDOF()); setIdentity();};
...
{
public:
  Transform3dAffine() { parameters.set_size(getDOF()); setIdentity();};
...
{
public:
  Transform3dAffine2() { parameters.set_size(getDOF()); setIdentity();};
  ...
  {
    vnl_vector < double > v(getDOF(),0.001);
    v[0] = 0.02; v[1] = 0.02; v[2] = 0.02;
    v[6] = 0.01; v[7] = 0.01; v[8] = 0.01;
    return v;
  };
  virtual vnl_matrix_fixed < double, 4, 4 > getMatrix() const
  {
    ...
    //Scale
    vnl_matrix < double > smat(3,3,0.0);
    smat[0][0] = parameters[6]; smat[1][1] = parameters[7]; smat[2][2] = parameters[8];
    //Shear
    vnl_matrix <double > zmat(3,3); zmat.set_identity();
    zmat[0][1] = parameters[9]; zmat[0][2] = parameters[10]; zmat[1][2] = parameters[11];
    // product 3x3
    vnl_matrix <double> M3 = zmat * smat * rmat;
    // consturct 4x4 with translation also:
    vnl_matrix_fixed <double,4,4 > ret;
  ...
  inline virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const
  {
    std::cerr << " Affine in 3D (type 2): gradient not implemented!" <<std::endl;
    exit(1);
    vnl_vector < double > ret(12);
    ret[0]  = fx*x;
    ret[1]  = fx*y;
...
{
public:
  Transform3dIsoscale() { parameters.set_size(getDOF()); setIdentity();};
  ...
  virtual vnl_matrix_fixed < double, 4, 4 > getMatrix() const
  {
    std::cerr << " Isoscale in 3D not implemented yet, use ridig or affine" <<std::endl;
    exit(1);
    vnl_matrix_fixed <double,4,4 > ret;
    // M = T*(Scale*Rot)
...
{
public:
  Transform3dIsoscale2() { parameters.set_size(getDOF()); setIdentity();};
  ...
  inline virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const
  {
    std::cerr << " Isoscale in 3D (type 2): gradient not implemented!" <<std::endl;
    exit(1);
    vnl_vector < double > ret(7);
    ret[0] =  fx;
    ret[1] =  fy;
...
{
public:
  Transform3dRigid() { parameters.set_size(getDOF()); setIdentity();};
...
{
public:
  Transform3dRigid2() { parameters.set_size(getDOF()); setIdentity();};
  ...
  inline virtual vnl_vector < double > getGradient(const unsigned int& x, const float& fx, const unsigned int& y, const float& fy, const unsigned int& z, const float& fz) const
  {
    std::cerr << "ERROR rigid in 3D (type 2): gradient not implemented !" <<std::endl;
    exit(1);
    vnl_vector < double > ret(6);
    ret[0] =  fx;
    ret[1] =  fy;
...
{
public:
  Transform3dTranslate() { parameters.set_size(getDOF()); setIdentity();};
