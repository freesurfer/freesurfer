...
static double
FLASHforwardModelLookup(double T1, double PD, double TR, double flip_angle)
{
  double FLASH ;
...
static int
build_lookup_table(double tr, double flip_angle, double te,
...
int
FlashBuildLookupTables(int nvolumes, double *TRs, double *FAs, double *TEs)
{
  int n ;
