...
static void
add_face(int imnr, int i, int j, int f, int prev_flag,tesselation_parms *parms)
{
...
static int
add_vertex(int imnr, int i, int j,tesselation_parms *parms)
{
...
static void
make_surface(tesselation_parms *parms)
{
