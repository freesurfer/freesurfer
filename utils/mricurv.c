...
static float computeLocalCurvature(int *ref_tab,int connectivity)
{
  ...
  if(reference&&reference!=255)
	...
	if(vt[n])
	  {
	    if(n==1) {vind[n]=save_vertex_indice[10];continue;}
	    if(n==4) {vind[n]=save_vertex_indice[20];continue;}
	    if(n==6) {vind[n]=save_vertex_indice[24];continue;}
	    if(n==9) {vind[n]=save_vertex_indice[14];continue;}
  ...
  if(reference&&reference!=255)
	...
	if(vt[n])
	  {
	    if(n==0) {vind[n]=save_vertex_indice[0];continue;}
	    if(n==4) {vind[n]=save_vertex_indice[22];continue;}
	    if(n==5) {vind[n]=save_vertex_indice[24];continue;}
	    if(n==8) {vind[n]=save_vertex_indice[4];continue;}
  ...
  if(reference&&reference!=255)
	...
	if(vt[n])
	  {
	    if(n==0) {vind[n]=save_vertex_indice[1];continue;}
	    if(n==1) {vind[n]=save_vertex_indice[11];continue;}
	    if(n==4) {vind[n]=save_vertex_indice[24];continue;}
	    if(n==5) {vind[n]=save_vertex_indice[26];continue;}
	    if(n==6) {vind[n]=save_vertex_indice[28];continue;}
	    if(n==8) {vind[n]=save_vertex_indice[5];continue;}
	    if(n==9) {vind[n]=save_vertex_indice[15];continue;}
  ...
  if(reference&&reference!=255)
	...
	if(vt[n])
	  {
	    if(n==0) {vind[n]=save_vertex_indice[2];continue;}
	    if(n==1) {vind[n]=save_vertex_indice[12];continue;}
	    if(n==2) {vind[n]=save_vertex_indice[4];continue;}
	    if(n==3) {vind[n]=save_vertex_indice[14];continue;}
  ...
  if(reference&&reference!=255)
	...
	if(vt[n])
	  {
	    if(n==0) {vind[n]=save_vertex_indice[3];continue;}
	    if(n==1) {vind[n]=save_vertex_indice[14];continue;}
	    if(n==2) {vind[n]=save_vertex_indice[5];continue;}
	    if(n==3) {vind[n]=save_vertex_indice[16];continue;}
	    if(n==4) {vind[n]=save_vertex_indice[21];continue;}
	    if(n==6) {vind[n]=save_vertex_indice[25];continue;}
	    if(n==9) {vind[n]=save_vertex_indice[18];continue;}
  ...
  if(reference&&reference!=255)
	...
	if(vt[n])
	  {
	    if(n==0) {vind[n]=save_vertex_indice[4];continue;}
	    if(n==1) {vind[n]=save_vertex_indice[13];continue;}
	    if(n==2) {vind[n]=save_vertex_indice[6];continue;}
	    if(n==3) {vind[n]=save_vertex_indice[15];continue;}
	    if(n==4) {vind[n]=save_vertex_indice[23];continue;}
	    if(n==5) {vind[n]=save_vertex_indice[25];continue;}
	    if(n==8) {vind[n]=save_vertex_indice[8];continue;}
  ...
  if(reference&&reference!=255)
	...
	if(vt[n])
	  {
	    if(n==0) {vind[n]=save_vertex_indice[5];continue;}
	    if(n==1) {vind[n]=save_vertex_indice[15];continue;}
	    if(n==2) {vind[n]=save_vertex_indice[7];continue;}
	    if(n==3) {vind[n]=save_vertex_indice[17];continue;}
	    if(n==4) {vind[n]=save_vertex_indice[25];continue;}
	    if(n==5) {vind[n]=save_vertex_indice[27];continue;}
	    if(n==6) {vind[n]=save_vertex_indice[29];continue;}
	    if(n==8) {vind[n]=save_vertex_indice[9];continue;}
	    if(n==9) {vind[n]=save_vertex_indice[19];continue;}
