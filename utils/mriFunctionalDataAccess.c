...
FunD_tErr FunD_New(mriFunctionalDataRef *opVolume,
  ...
  DebugEnterFunction(
      ("FunD_New( opVolume=%p, isFileName=%s, "
...
FunD_tErr FunD_ReshapeIfScalar_(mriFunctionalDataRef this,
  ...
  DebugEnterFunction(
      ("FunD_ReshapeIfScalar_( this=%p, inNumValues=%d, "
       "obReshaped=%p )",
       this,
       inNumValues,
       obReshaped));
  ...
  switch (iType) {
    ...
    case FunD_tRegistration_Find:
      ...
      if (!FEQUAL(this->mpData->xsize, theRegInfo->in_plane_res) ||
        ...
        DebugPrint(
            ("\tWARNING: MRI xsize and zsize are not equal to "
...
#ifndef BE_SUPA_FAST
  DebugEnterFunction(
      ("FunD_GetData( this=%p, iClientVox=%p, "
...
#ifndef BE_SUPA_FAST
  DebugEnterFunction(
      ("FunD_GetSampledData( this=%p, iClientVox=%p, "
       "iCondition=%d, iTimePoint=%d, oValue=%p)",
       this,
       iClientVox,
       iCondition,
...
FunD_tErr FunD_GetDataForAllTimePoints(mriFunctionalDataRef this,
  ...
  DebugEnterFunction(
      ("FunD_GetDataForAllTimePoints( this=%p, iClientVox=%p, "
...
FunD_tErr FunD_GetDeviation(
  ...
  DebugEnterFunction(
      ("FunD_GetDeviation( this=%p, iCondition=%d, "
...
FunD_tErr FunD_Smooth(mriFunctionalDataRef this, int iTimePoint, int iCondition, float iSigma) {
  ...
  DebugEnterFunction(
      ("FunD_Smooth( this=%p, iCondition=%d, "
...
FunD_tErr FunD_ConvertTimePointToSecond(mriFunctionalDataRef this, int iTimePoint, float *oSecond) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertTimePointToSecond( this=%p, "
...
FunD_tErr FunD_ConvertSecondToTimePoint(mriFunctionalDataRef this, float iSecond, int *oTimePoint) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertSecondToTimePoint( this=%p, iSecond=%f, "
       "oTimePoint=%p)",
       this,
       iSecond,
       oTimePoint));
...
FunD_tErr FunD_GetBoundsInClientSpace(mriFunctionalDataRef this, xVoxelRef oBeginCorner, xVoxelRef oEndCorner) {
  ...
  DebugEnterFunction(
      ("FunD_GetBoundsInClientSpace( this=%p, "
...
FunD_tErr FunD_GetValueAtPercentile(mriFunctionalDataRef this, float iPercentile, float *oValue) {
  ...
  DebugEnterFunction(
      ("FunD_GetValueAtPercentile( this=%p, iPercentile=%f, "
       "oValue=%p)",
       this,
       iPercentile,
       oValue));
...
FunD_tErr FunD_CalcFDRThreshold(mriFunctionalDataRef this,
  ...
  DebugEnterFunction(
      ("FunD_CalcFDRThreshold( this=%p, iCondition=%d, "
...
FunD_tErr FunD_ApplyTransformToRegistration(mriFunctionalDataRef this, MATRIX *iTransform) {
  ...
  DebugEnterFunction(
      ("FunD_ApplyTransformToRegistration( this=%p )"
       "iTransform=%p",
       this,
       iTransform));
...
FunD_tErr FunD_TranslateRegistration(mriFunctionalDataRef this, float ifDistance, tAxis iAxis) {
  ...
  DebugEnterFunction(
      ("FunD_TranslateRegistration( this=%p )"
...
FunD_tErr FunD_RotateRegistration(mriFunctionalDataRef this, float ifDegrees, tAxis iAxis, xVoxelRef iCenterFuncRAS) {
  ...
  DebugEnterFunction(
      ("FunD_RotateRegistration( this=%p, ifDegrees=%f, "
...
FunD_tErr FunD_ScaleRegistration(mriFunctionalDataRef this, float ifFactor, tAxis iAxis) {
  ...
  DebugEnterFunction(
      ("FunD_ScaleRegistration( this=%p, ifFactor=%f, "
       "iAxis=%d",
       this,
       ifFactor,
       iAxis));
...
void FunD_ConvertClientToFuncIdx_(mriFunctionalDataRef this, xVoxelRef iClientVox, xVoxelRef oFuncIdx) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertClientToFuncIdx_( this=%p, iClientVox=%p, "
       "oFuncIdx=%p",
       this,
       iClientVox,
       oFuncIdx));
...
void FunD_ConvertClientToFloatFuncIdx_(mriFunctionalDataRef this, xVoxelRef iClientVox, xVoxelRef oFuncIdx) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertClientToFloatFuncIdx_( this=%p, iClientVox=%p, "
       "oFuncIdx=%p",
       this,
       iClientVox,
       oFuncIdx));
...
void FunD_ConvertClientToFuncRAS_(mriFunctionalDataRef this, xVoxelRef iClientVox, xVoxelRef oFuncRAS) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertClientToFuncRAS_( this=%p, iClientVox=%p, "
       "oFuncRAS=%p",
       this,
       iClientVox,
       oFuncRAS));
...
void FunD_ConvertFuncIdxToClient_(mriFunctionalDataRef this, xVoxelRef iFuncIdx, xVoxelRef oClientVox) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertFuncIdxToClient_( this=%p, iFuncIdx=%p, "
       "oClientVox=%p",
       this,
       iFuncIdx,
       oClientVox));
...
void FunD_ConvertRASToFuncIdx_(mriFunctionalDataRef this, xVoxelRef iRAS, xVoxelRef oFuncIdx) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertRASToFuncIdx_( this=%p, iRAS=%p, "
       "oFuncIdx=%p",
       this,
       iRAS,
       oFuncIdx));
...
void FunD_ConvertFuncIdxToFuncRAS_(mriFunctionalDataRef this, xVoxelRef iFuncIdx, xVoxelRef oFuncRAS) {
  ...
  DebugEnterFunction(
      ("FunD_ConvertFuncIdxToFuncRAS_( this=%p, iFuncIdx=%p, "
       "oFuncRAS=%p",
       this,
       iFuncIdx,
       oFuncRAS));
