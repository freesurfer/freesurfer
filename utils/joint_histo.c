...
inline float flmin(float a, float b)
{
  return (a < b) ? a : b;
}
inline float flmax(float a, float b)
{
  return (a > b) ? a : b;
}
...
/*-----------------------------------------------------
  ...
  ------------------------------------------------------*/
int
JHISTOfree(JOINT_HISTOGRAM **pjhisto)
{
...
/*-----------------------------------------------------
  ...
  ------------------------------------------------------*/
int
JHISTOdump(JOINT_HISTOGRAM *jhisto, FILE *fp)
{
...
int
JHISTOwriteInto(JOINT_HISTOGRAM *h, FILE *fp)
{
  int b1, b2 ;
...
JOINT_HISTOGRAM *
JHISTOalloc(int nbins_1, int nbins_2)
{
  JOINT_HISTOGRAM *jhisto ;
...
JOINT_HISTOGRAM *
JHISTOrealloc(JOINT_HISTOGRAM *jhisto, int nbins_1, int nbins_2)
{
  if (jhisto == NULL)
...
int 
JHISTOfindBin(JOINT_HISTOGRAM* jhisto, double val1, double val2)
{
...
void 
JHISTOfill(MRI* mri1, MRI* mri2, JOINT_HISTOGRAM* jhisto) 
{
...
double
JHISTOgetEntropy(JOINT_HISTOGRAM* jhisto)
{
  double result = 0, p;
  int i, count;
