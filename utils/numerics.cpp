...
static void ConvertFromFloatToVNLDouble
( const float *iaSource,
...
static void ConvertFromVNLDoubleToFloat
( const vnl_vector< double > iSource,
...
static void ConvertFromVNLDoubleToFloat
( const vnl_matrix< double > iSource,
  float **oaDestination, const int icSourceAndDestination )
{
  // indexing p at 1 because of NR legacy
  for ( int row=0; row< icSourceAndDestination; row++ )
                              ...
                              float *oY)
{
  ...
  *oY = SplineCubicValue( icYSecondDerivatives, iaX, iX, iaY,
                          iaYSecondDerivatives, &firstDerivative,
                          &secondDerivative );
