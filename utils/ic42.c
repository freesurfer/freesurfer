...
IC_FACE ic42_faces[ICO_NFACES] = {
    {{1, 13, 15}},  {{13, 5, 14}},  {{15, 13, 14}}, {{15, 14, 4}},  {{1, 16, 13}},  {{16, 6, 17}},  {{13, 16, 17}},
    {{13, 17, 5}},  {{1, 18, 16}},  {{18, 2, 19}},  {{16, 18, 19}}, {{16, 19, 6}},  {{1, 20, 18}},  {{20, 3, 21}},
    {{18, 20, 21}}, {{18, 21, 2}},  {{1, 15, 20}},  {{15, 4, 22}},  {{20, 15, 22}}, {{20, 22, 3}},  {{4, 23, 22}},
    {{23, 9, 24}},  {{22, 23, 24}}, {{22, 24, 3}},  {{4, 25, 23}},  {{25, 10, 26}}, {{23, 25, 26}}, {{23, 26, 9}},
    {{4, 14, 25}},  {{14, 5, 27}},  {{25, 14, 27}}, {{25, 27, 10}}, {{5, 28, 27}},  {{28, 11, 29}}, {{27, 28, 29}},
    {{27, 29, 10}}, {{5, 17, 28}},  {{17, 6, 30}},  {{28, 17, 30}}, {{28, 30, 11}}, {{6, 31, 30}},  {{31, 7, 32}},
    {{30, 31, 32}}, {{30, 32, 11}}, {{6, 19, 31}},  {{19, 2, 33}},  {{31, 19, 33}}, {{31, 33, 7}},  {{2, 34, 33}},
    {{34, 8, 35}},  {{33, 34, 35}}, {{33, 35, 7}},  {{2, 21, 34}},  {{21, 3, 36}},  {{34, 21, 36}}, {{34, 36, 8}},
    {{3, 24, 36}},  {{24, 9, 37}},  {{36, 24, 37}}, {{36, 37, 8}},  {{9, 26, 39}},  {{26, 10, 38}}, {{39, 26, 38}},
    {{39, 38, 12}}, {{10, 29, 38}}, {{29, 11, 40}}, {{38, 29, 40}}, {{38, 40, 12}}, {{11, 32, 40}}, {{32, 7, 41}},
    {{40, 32, 41}}, {{40, 41, 12}}, {{7, 35, 41}},  {{35, 8, 42}},  {{41, 35, 42}}, {{41, 42, 12}}, {{8, 37, 42}},
    {{37, 9, 39}},  {{42, 37, 39}}, {{42, 39, 12}}};
MRI_SURFACE *ic42_make_surface(int max_vertices, int max_faces) {
  ...
  for (vno = 0; vno < ICO_NVERTICES; vno++) {
    ...
    if (!v->v) ErrorExit(ERROR_NOMEMORY, "ic42: could not allocate %dth vertex list.", vno);
    v->vnum = 0;
  }
  ...
  for (vno = 0; vno < ICO_NVERTICES; vno++) {
    ...
    if (!v->f) ErrorExit(ERROR_NO_MEMORY, "ic42: could not allocate %d faces", v->num);
    v->n = (uchar *)calloc(v->num, sizeof(uchar));
    if (!v->n) ErrorExit(ERROR_NO_MEMORY, "ic42: could not allocate %d nbrs", v->n);
