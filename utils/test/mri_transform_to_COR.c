...
static char vcid[] =
  "$Id: mri_transform_to_COR.c,v 1.7 2006/12/29 01:49:45 nicks Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_transform_to_COR.c,v 1.7 2006/12/29 01:49:45 nicks Exp $", "$Name:  $");
