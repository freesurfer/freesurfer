...
static char vcid[] = "$Id: mris_compute_thickness.cpp,v 1.3 2006/12/29 01:49:46 nicks Exp $";
...
int main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_compute_thickness.cpp,v 1.3 2006/12/29 01:49:46 nicks Exp $", "$Name:  $");
