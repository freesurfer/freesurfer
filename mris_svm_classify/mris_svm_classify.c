...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_svm_classify.c,v 1.3 2003/09/05 04:45:44 kteich Exp $", "$Name:  $");
  ...
  surf_name = argv[3] ; input_name = argv[4] ; 
  output_subject_name = argv[5] ; svm_name = argv[6] ; 
  ...
  free(inputs) ; MRISfree(&mris) ; SVMfree(&svm) ;
