...
static char vcid[] = "$Id: spherical_stats.c,v 1.5 2006/06/01 22:31:36 kteich Exp $";
...
int main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: spherical_stats.c,v 1.5 2006/06/01 22:31:36 kteich Exp $", "$Name:  $");
