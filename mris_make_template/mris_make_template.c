...
static char vcid[] = "$Id: mris_make_template.c,v 1.7 2003/04/17 18:43:14 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_make_template.c,v 1.7 2003/04/17 18:43:14 kteich Exp $");
