...
static char vcid[] = "$Id: mris_make_template.c,v 1.17 2006/05/22 18:25:19 greve Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_make_template.c,v 1.17 2006/05/22 18:25:19 greve Exp $", "$Name:  $");
