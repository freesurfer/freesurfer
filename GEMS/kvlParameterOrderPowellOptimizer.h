...
public:
  ...
  virtual const unsigned int&  GetCurrentIteration() const { return m_WrappedOptimizer->GetCurrentIteration(); }
  virtual void  SetMaximize(bool maximize ) { m_WrappedOptimizer->SetMaximize( maximize ); }
  virtual void  MaximizeOn() { m_WrappedOptimizer->SetMaximize( true ); }
  virtual void  MaximizeOff() { m_WrappedOptimizer->SetMaximize( false ); }
  virtual const bool&  GetMaximize() const { return m_WrappedOptimizer->GetMaximize(); }
  virtual void  SetMaximumIteration( unsigned int maximumIteration ) { m_WrappedOptimizer->SetMaximumIteration( maximumIteration ); }
  virtual const unsigned int&  GetMaximumIteration() const { return m_WrappedOptimizer->GetMaximumIteration(); }
  virtual void  SetMaximumLineIteration( unsigned int maximumLineIteration ) { m_WrappedOptimizer->SetMaximumLineIteration( maximumLineIteration ); }
  virtual unsigned int  GetMaximumLineIteration() const { return m_WrappedOptimizer->GetMaximumLineIteration(); }
  virtual void  SetStepLength( double stepLength ) { m_WrappedOptimizer->SetStepLength( stepLength ); }
  virtual const double&  GetStepLength() const { return m_WrappedOptimizer->GetStepLength(); }
  virtual void  SetStepTolerance( double stepTolerance ) { m_WrappedOptimizer->SetStepTolerance( stepTolerance ); }
  virtual const double&  GetStepTolerance() const { return m_WrappedOptimizer->GetStepTolerance(); }
  virtual void  SetValueTolerance( double valueTolerance ) { m_WrappedOptimizer->SetValueTolerance( valueTolerance ); }
  virtual const double&  GetValueTolerance() const { return m_WrappedOptimizer->GetValueTolerance(); }
  virtual const MeasureType&   GetCurrentCost() const { return m_WrappedOptimizer->GetCurrentCost(); }
