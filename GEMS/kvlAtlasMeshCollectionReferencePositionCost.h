/**
 * @file  kvlAtlasMeshCollectionReferencePositionCost.h
...
class AtlasMeshCollectionReferencePositionCost : public itk::SingleValuedCostFunction
{

public:
  /** Standard class typedefs. */
  typedef AtlasMeshCollectionReferencePositionCost     Self;
  typedef itk::SingleValuedCostFunction                 Superclass;
  typedef itk::SmartPointer<Self>           Pointer;
  typedef itk::SmartPointer<const Self>     ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro( AtlasMeshCollectionReferencePositionCost, itk::SingleValuedCostFunction );
  ...
  void SetInitialMeshCollections( AtlasMeshCollection* estimationMeshCollection,
...
protected:
  ...
  virtual ~AtlasMeshCollectionReferencePositionCost();

  void CalculateVertexNeighborhood() const;

private:
  AtlasMeshCollectionReferencePositionCost(const Self&); //purposely not implemented
