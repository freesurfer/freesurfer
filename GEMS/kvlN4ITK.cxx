/**
 * @file  kvlN4ITK.cxx
 * @brief Uses N4-ITK lib to perform bias correction on a volume
 *
 * See these sources:
 *   http://www.kitware.com/media/html/N3ITKImplementationForMRIBiasFieldCorrection.html
 * 
 *   http://www.slicer.org/slicerWiki/index.php/Modules:N4ITKBiasFieldCorrection-Documentation-3.6
 */
/*
 * Original Author: Ben Lewin, from kvlConvert by Koen Van Leemput
 * CVS Revision Info:
 *    $Author: nicks $
 *    $Date: 2014/07/14 19:16:35 $
 *    $Revision: 1.1 $
 *
