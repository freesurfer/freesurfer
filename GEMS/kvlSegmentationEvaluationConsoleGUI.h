...
#ifndef kvlSegmentationEvaluationConsoleGUI_h
#define kvlSegmentationEvaluationConsoleGUI_h
#include <FL/Fl.H>
...
class kvlSegmentationEvaluationConsoleGUI {
public:
  kvlSegmentationEvaluationConsoleGUI();
...
private:
  void cb_m_ImageViewer1_i(kvl::ImageViewer*, void*);
  static void cb_m_ImageViewer1(kvl::ImageViewer*, void*);
public:
  kvl::ImageViewer *m_ImageViewer2;
private:
  void cb_m_ImageViewer2_i(kvl::ImageViewer*, void*);
  static void cb_m_ImageViewer2(kvl::ImageViewer*, void*);
public:
...
private:
  void cb_m_Swap_i(Fl_Check_Button*, void*);
  static void cb_m_Swap(Fl_Check_Button*, void*);
public:
  virtual ~kvlSegmentationEvaluationConsoleGUI();
