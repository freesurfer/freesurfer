/*=========================================================================
  ...
  Module:    vtkRGBAColorTransferFunction.h
...
#ifndef vtkRGBAColorTransferFunction_h
#define vtkRGBAColorTransferFunction_h
...
class VTKRENDERINGCORE_EXPORT vtkRGBAColorTransferFunction : public vtkScalarsToColors
{
public:
  ...
  int AddRGBAPoint(double x, double r, double g, double b, double a, double midpoint, double sharpness);
  int AddHSVAPoint(double x, double h, double s, double v, double a);
  int AddHSVAPoint(double x, double h, double s, double v, double a, double midpoint, double sharpness);
  ...
  void GetColor(double x, double rgba[4]) override;
...
protected:
  ...
  ~vtkRGBAColorTransferFunction() override;
...
private:
  vtkRGBAColorTransferFunction(const vtkRGBAColorTransferFunction&) = delete;
  void operator=(const vtkRGBAColorTransferFunction&) = delete;
};
