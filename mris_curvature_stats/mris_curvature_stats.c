...
static char vcid[] =
  "$Id: mris_curvature_stats.c,v 1.33 2007/09/05 14:59:01 rudolph Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv,
	"$Id: mris_curvature_stats.c,v 1.33 2007/09/05 14:59:01 rudolph Exp $", "$Name:  $");
