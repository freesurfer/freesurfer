...
static char vcid[] = "$Id: mris_jacobian.c,v 1.4 2003/04/17 18:39:17 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_jacobian.c,v 1.4 2003/04/17 18:39:17 kteich Exp $");
