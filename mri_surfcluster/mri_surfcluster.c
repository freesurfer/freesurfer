...
/*
  ...
  $Id: mri_surfcluster.c,v 1.40 2008/01/29 22:56:00 greve Exp $
*/
...
static char vcid[] = "$Id: mri_surfcluster.c,v 1.40 2008/01/29 22:56:00 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_surfcluster.c,v 1.40 2008/01/29 22:56:00 greve Exp $", "$Name:  $");
