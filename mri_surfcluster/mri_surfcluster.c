/*
  ...
  $Id: mri_surfcluster.c,v 1.28 2006/03/06 22:43:20 greve Exp $
*/
...
static char vcid[] = "$Id: mri_surfcluster.c,v 1.28 2006/03/06 22:43:20 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv)
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_surfcluster.c,v 1.28 2006/03/06 22:43:20 greve Exp $", "$Name:  $");
