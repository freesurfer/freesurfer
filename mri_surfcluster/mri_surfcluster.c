...
static char vcid[] = "$Id: mri_surfcluster.c,v 1.57.2.1 2016/09/12 15:43:48 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_surfcluster.c,v 1.57.2.1 2016/09/12 15:43:48 greve Exp $", "$Name: stable6 $");
...
static void print_help(void) {
  ...
  printf(
    ...
    "$Id: mri_surfcluster.c,v 1.57.2.1 2016/09/12 15:43:48 greve Exp $\n"
    "Input :      minsig-0-lh.w\n"
    "Frame Number:      0\n"
    "Minimum Threshold: 5\n"
