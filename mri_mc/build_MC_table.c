...
static int Reverse(int *f,int *v,int *fd, int *vd)
{
  ...
  for(k=0;k<8;k++)
      ...
      while(v[p]>=0)
	{
      ...
      if(!test)
	{
	  vd[n]=tb[k][0];vd[n+1]=tb[k][1];vd[n+2]=tb[k][2];
	  n+=3;
	}
    }
  return gNb(vd);
...
static void initPoints(void)
{
  ...
  k=5;
  //3 points
  Pt[k][0]=1;Pt[k][1]=0;Pt[k][2]=0;
  Pt[k][3]=1;Pt[k][4]=1;Pt[k][5]=0;
  Pt[k][6]=0;Pt[k][7]=1;Pt[k][8]=0;

  //case 6: 3 faces (6-connectivity)
  k=6;
  //3 points
  Pt[k][0]=0;Pt[k][1]=0;Pt[k][2]=0;
  Pt[k][3]=1;Pt[k][4]=0;Pt[k][5]=0;
  Pt[k][6]=1;Pt[k][7]=1;Pt[k][8]=1;

  //case 7: 3 faces (6-connectivity)
  k=7;
  //3 points
  Pt[k][0]=0;Pt[k][1]=0;Pt[k][2]=1;
  Pt[k][3]=1;Pt[k][4]=0;Pt[k][5]=0;
  Pt[k][6]=1;Pt[k][7]=1;Pt[k][8]=1;
  ...
  Pt[k][3]=1;Pt[k][4]=0;Pt[k][5]=0;
  Pt[k][6]=0;Pt[k][7]=1;Pt[k][8]=0;
  Pt[k][9]=1;Pt[k][10]=1;Pt[k][11]=0;

  //case 9: 4 faces 
  k=9;
  //4 points
  Pt[k][0]=0;Pt[k][1]=0;Pt[k][2]=0;
  Pt[k][3]=0;Pt[k][4]=1;Pt[k][5]=0;
  Pt[k][6]=1;Pt[k][7]=1;Pt[k][8]=0;
  Pt[k][9]=0;Pt[k][10]=1;Pt[k][11]=1;

  //case 10: 4 faces 
  k=10;
  //4 points
  Pt[k][0]=0;Pt[k][1]=0;Pt[k][2]=0;
  Pt[k][3]=0;Pt[k][4]=0;Pt[k][5]=1;
  Pt[k][6]=1;Pt[k][7]=1;Pt[k][8]=1;
  Pt[k][9]=1;Pt[k][10]=1;Pt[k][11]=0;
  ...
  Pt[k][3]=0;Pt[k][4]=1;Pt[k][5]=0;
  Pt[k][6]=1;Pt[k][7]=1;Pt[k][8]=0;
  Pt[k][9]=0;Pt[k][10]=0;Pt[k][11]=1;

  //case 13: 4 faces 
  k=13;
  //4 points
  Pt[k][0]=0;Pt[k][1]=0;Pt[k][2]=0;
  Pt[k][3]=0;Pt[k][4]=1;Pt[k][5]=1;
  Pt[k][6]=1;Pt[k][7]=1;Pt[k][8]=0;
  Pt[k][9]=1;Pt[k][10]=0;Pt[k][11]=1;
