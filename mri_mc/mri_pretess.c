...
int main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_pretess.c,v 1.13 2006/01/29 21:00:55 greve Exp $", "$Name:  $");

  make_cmd_version_string (argc, argv, "$Id: mri_pretess.c,v 1.13 2006/01/29 21:00:55 greve Exp $", "$Name:  $", cmdline);
