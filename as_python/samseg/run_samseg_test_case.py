...
def run_samseg_test_cases(case_names=None, testing_dir=None):
    ...
    for case_name in case_names:
        run_single_case(case_name, testing_dir)

def run_single_case(case_name, testing_dir):
