  ...
  bool test()
    {
      ...
      matrixIntActual.push_back(vectIntRow); vectIntRow.erase(vectIntRow.begin(),vectIntRow.end());
      vectIntRow.push_back(-3);
      ...
      vectIntRow.push_back(5);
      matrixInt2Actual.push_back(vectIntRow); vectIntRow.erase(vectIntRow.begin(),vectIntRow.end());
      vectIntRow.push_back(4);
      vectIntRow.push_back(5);
      ...
      matrixDoubleActual.push_back(vectDoubleRow); vectDoubleRow.erase(vectDoubleRow.begin(),vectDoubleRow.end());
