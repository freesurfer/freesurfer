...
unsigned      :
  29;
unsigned      st_on:
  2; /* Duplicate write enable:0-mono
                    * 1-stereo */
}
...
unsigned      rgb_read_b:
  1;      /* RGB:read buffer B */
unsigned      rgb_write_b:
  1;     /* write buffer B */
unsigned      rgb_write_a:
  1;      /* write buffer A */
}
