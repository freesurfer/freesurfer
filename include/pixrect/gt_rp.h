...
unsigned pf_busy:
  1;  /* Pixel bus busy? RO */
unsigned pb_busy:
  1;  /* Pixel formatter busy? RO */
unsigned host_stall:
  1;  /* Host stalling RP? RW*/
unsigned H_rp_stall:
  1;  /* RP stalled? RO */
unsigned :
  1;   /* not used */
unsigned v_retrace:
  1; /* Vertical retrace? RO */
unsigned fb_stateset:
  1; /* Host FB stateset. RW */
}
H_rp_csr_reg_bit;
