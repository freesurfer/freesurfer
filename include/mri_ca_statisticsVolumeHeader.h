  ...
  bool find8ClosestVoxels(float fTiX, float fTiY, float fTiZ, TypeMatrixFloat& vectorCanonicalPointsForInterpolation)
    {
      ...
      vectPoint.clear();      vectPoint.push_back(fTiXPrev);       vectPoint.push_back(fTiYPrev);       vectPoint.push_back(fTiZPrev);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      vectPoint.clear();      vectPoint.push_back(fTiXPrev);       vectPoint.push_back(fTiYPrev);       vectPoint.push_back(fTiZNext);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      vectPoint.clear();      vectPoint.push_back(fTiXPrev);       vectPoint.push_back(fTiYNext);       vectPoint.push_back(fTiZPrev);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      vectPoint.clear();      vectPoint.push_back(fTiXPrev);       vectPoint.push_back(fTiYNext);       vectPoint.push_back(fTiZNext);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      vectPoint.clear();      vectPoint.push_back(fTiXNext);       vectPoint.push_back(fTiYPrev);       vectPoint.push_back(fTiZPrev);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      vectPoint.clear();      vectPoint.push_back(fTiXNext);       vectPoint.push_back(fTiYPrev);       vectPoint.push_back(fTiZNext);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      vectPoint.clear();      vectPoint.push_back(fTiXNext);       vectPoint.push_back(fTiYNext);       vectPoint.push_back(fTiZPrev);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      vectPoint.clear();      vectPoint.push_back(fTiXNext);       vectPoint.push_back(fTiYNext);       vectPoint.push_back(fTiZNext);
      vectorCanonicalPointsForInterpolation.push_back(vectPoint);
      return(true);
    }
