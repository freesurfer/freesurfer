...
static char vcid[] = "$Id: mri_synthesize.c,v 1.17 2006/12/29 02:09:09 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  make_cmd_version_string (argc, argv, "$Id: mri_synthesize.c,v 1.17 2006/12/29 02:09:09 nicks Exp $", "$Name:  $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv, "$Id: mri_synthesize.c,v 1.17 2006/12/29 02:09:09 nicks Exp $", "$Name:  $");
