...
/*
  ...
  Date:    1/2/00
  $Id: mri_vol2roi.c,v 1.26.2.2 2008/04/02 22:28:56 greve Exp $
*/
...
static char vcid[] = "$Id: mri_vol2roi.c,v 1.26.2.2 2008/04/02 22:28:56 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_vol2roi.c,v 1.26.2.2 2008/04/02 22:28:56 greve Exp $", "$Name:  $");
