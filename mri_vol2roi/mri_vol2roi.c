...
/*
  ...
  Date:    1/2/00
  $Id: mri_vol2roi.c,v 1.26.2.1 2008/01/16 03:51:32 greve Exp $
*/
...
static char vcid[] = "$Id: mri_vol2roi.c,v 1.26.2.1 2008/01/16 03:51:32 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_vol2roi.c,v 1.26.2.1 2008/01/16 03:51:32 greve Exp $", "$Name:  $");
