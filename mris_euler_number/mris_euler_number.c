...
static char vcid[] = "$Id: mris_euler_number.c,v 1.4 2003/09/05 04:45:41 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_euler_number.c,v 1.4 2003/09/05 04:45:41 kteich Exp $", "$Name:  $");
