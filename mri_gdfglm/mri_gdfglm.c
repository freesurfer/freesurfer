...
static char vcid[] = "$Id: mri_gdfglm.c,v 1.8 2011/03/02 00:04:16 nicks Exp $";
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_gdfglm.c,v 1.8 2011/03/02 00:04:16 nicks Exp $", "$Name:  $");
