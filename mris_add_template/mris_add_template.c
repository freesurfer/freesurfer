...
static char vcid[] = "$Id: mris_add_template.c,v 1.5 2003/09/05 04:45:39 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_add_template.c,v 1.5 2003/09/05 04:45:39 kteich Exp $", "$Name:  $");
