...
set MRFCONSTANT="0";
set SUFFIX="${T2NAME}_v1.0";
set BYPASSBF="1";
set USEWHOLEBRAININHP="0";

# command
set cmd="$SCRIPTPATH/run_segmentSubjectT2_autoEstimateAlveusML.sh $RUNTIME $SUBJECTNAME $SUBJECTDIR $T2VOL $RESOLUTION $ATLASMESH $ATLASDUMP $LUT $K $SIDE $OPTIMIZER $SUFFIX ${FREESURFER_HOME}/bin/ $MRFCONSTANT $BYPASSBF $USEWHOLEBRAININHP"
