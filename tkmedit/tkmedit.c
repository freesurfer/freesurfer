...
char *VERSION = "$Revision: 1.320.2.1 $";
...
void ParseCmdLineArgs ( int argc, char *argv[] ) {
  ...
  nNumProcessedVersionArgs =
    ...
    (argc, argv,
     "$Id: tkmedit.c,v 1.320.2.1 2007/08/21 18:05:43 nicks Exp $",
     "$Name:  $");
...
int main ( int argc, char** argv ) {
  ...
  *MATRIX_RELT(gm_screen2ras, 4, 4) = 1 ;
  ...
  DebugPrint
    (
      (
        "$Id: tkmedit.c,v 1.320.2.1 2007/08/21 18:05:43 nicks Exp $ $Name:  $\n"
        )
      );
