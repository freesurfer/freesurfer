...
static char vcid[] = "$Id: mri_map_atrophy.c,v 1.3 2006/12/29 02:09:07 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_map_atrophy.c,v 1.3 2006/12/29 02:09:07 nicks Exp $", "$Name:  $");
