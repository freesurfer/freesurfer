...
#ifdef FS_CUDA
const string outFileDefault = "energySmooth.gpu";
#else
const string outFileDefault = "energySmooth.cpu";
#endif
...
const char* Progname = "gcam_smoothnessenergy_test";
...
int main( int argc, char *argv[] ) {
  ...
  cout << "GCAM Smoothness Energy Tester" << endl;
  cout << "=============================" << endl << endl;
  ...
  // ============================================
  // Produce output
  cout << "Smoothness Energy = " << smoothenergy << endl;
  ...
  oFile.write( reinterpret_cast<const char*>(&smoothenergy),
	       sizeof(smoothenergy) );
  oFile.close();
