...
static char vcid[] = "$Id: mris_talairach.c,v 1.4 2006/12/29 02:09:11 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_talairach.c,v 1.4 2006/12/29 02:09:11 nicks Exp $", "$Name:  $");
