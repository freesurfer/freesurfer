...
static char vcid[] = "$Id: mris_talairach.c,v 1.2 2003/04/17 19:04:30 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_talairach.c,v 1.2 2003/04/17 19:04:30 kteich Exp $");
