...
static char vcid[] = "$Id: mris_talairach.c,v 1.3 2003/09/05 04:45:44 kteich Exp $";
...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_talairach.c,v 1.3 2003/09/05 04:45:44 kteich Exp $", "$Name:  $");
