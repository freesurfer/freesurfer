...
static char vcid[] = "$Id: mris_ms_refine.c,v 1.18 2006/12/29 02:09:11 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  *xform_fname ;
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_ms_refine.c,v 1.18 2006/12/29 02:09:11 nicks Exp $", "$Name:  $");
