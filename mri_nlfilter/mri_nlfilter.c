...
static char vcid[] = "$Id: mri_nlfilter.c,v 1.11.2.1 2008/03/02 02:53:20 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  *mri_offset, *mri_up, *mri_polv, *mri_dir, *mri_clip, *mri_full ;
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_nlfilter.c,v 1.11.2.1 2008/03/02 02:53:20 nicks Exp $", "$Name:  $");
