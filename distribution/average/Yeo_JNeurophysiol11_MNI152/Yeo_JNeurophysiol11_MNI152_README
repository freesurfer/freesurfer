...
2) Seed-based fcMRI Movies can be downloaded here: http://www.youtube.com/YeoKrienen
Cerebellum seed-based fcMRI movies can be watched here: http://www.youtube.com/BucknerKrienen

3) Remember to also check out the cerebellar and striatum parcellations
