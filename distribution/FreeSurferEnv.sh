...
#
# $Id: FreeSurferEnv.sh,v 1.26 2006/08/18 21:22:25 nicks Exp $
#############################################################################

VERSION='$Id: FreeSurferEnv.sh,v 1.26 2006/08/18 21:22:25 nicks Exp $'
...
if [ -n "$VTK_DIR" ]; then
    ...
    if [ -z "$LD_LIBRARY_PATH" ]; then
        export LD_LIBRARY_PATH=$VTK_DIR/lib
    else
