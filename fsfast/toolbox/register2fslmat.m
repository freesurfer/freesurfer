function Mfsl = register2fslmat(R,cres,rres,sres,nc,nr,ns)
% Mfsl = register2fslmat(R,cres,rres,sres,nc,nr,ns)
%
...
if(nargin ~= 7)
  fprintf('R = register2fslmat(Mfsl,cres,rres,sres,nc,nr,ns)\n');
  return;
end
...
Mfsl = inv(Df*inv(Ff)*R*Fc*inv(Dc));
