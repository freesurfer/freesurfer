% fast_selxavg3.m
% $Id: fast_selxavg3.m,v 1.8 2006/11/18 23:25:46 greve Exp $
...
if(DoGLMFit)
  ...
  % Compute baseline (not sure why I need this)
  ...
  if(flac0.acfbins > 0)
    ...
    [edge bincenter binmap] = fast_histeq(ar1mn.vol(indmask), flac0.acfbins);
    acfseg = mri;
