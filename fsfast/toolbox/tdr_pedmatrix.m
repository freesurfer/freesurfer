function pedmat = tdr_pedmatrix(echo1ped,echospacing,delsamp,tDwell,nrows,ncols,nechoes)
% pedmat = tdr_pedmatrix(echo1ped,echospacing,delsamp,tDwell,nrows,ncols,nechoes) 
%
...
% 
% $Id: tdr_pedmatrix.m,v 1.1 2004/01/16 21:55:05 greve Exp $
%

pedmat = [];

if(nargin ~= 7)
  fprintf('pedmat = tdr_pedmatrix(echo1ped,echospacing,delsamp,tDwell,nrows,ncols,nechoes)\n');
  return;
end
