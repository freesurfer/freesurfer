...
static char vcid[] = "$Id: mri_evaluate_morph.c,v 1.4 2006/12/29 02:09:06 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_evaluate_morph.c,v 1.4 2006/12/29 02:09:06 nicks Exp $", "$Name:  $");
