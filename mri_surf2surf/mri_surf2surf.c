...
static char vcid[] = "$Id: mri_surf2surf.c,v 1.89 2011/03/02 00:04:25 nicks Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_surf2surf.c,v 1.89 2011/03/02 00:04:25 nicks Exp $", "$Name:  $");
