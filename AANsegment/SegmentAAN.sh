...
echo "freeview -v $SUBJECTS_DIR/$SUBJECTNAME/mri/T1.mgz -v $SUBJECTS_DIR/$SUBJECTNAME/mri/arousalNetworkLabels.$SUFFIX.mgz:colormap=lut:lut=$FREESURFER_HOME/average/AAN/atlas/freeview.lut.txt"
echo " "
