//Modified from mris_diff.cpp; trying replace ANN routine with HAST_TABLE method implemented in FreeSurfer
...
void FindClosest(MRI_SURFACE *TrueMesh, MHT *srcHash, MRI_SURFACE *EstMesh, double3d *closest);
