% **** new optimum 11.414 found at B1=0.475, B2=0.575 k_carbs=0.013, k_insulin=0.0150, SC=8.0, SI=56.0, C=7.00, BCI=0.5 *****
...
SI_best = 40 ; % insulin sensitivity, BG/insulin
b1_best = basal1 ;
b2_best = basal2 ;
C_best = 18 ; % carb ratio, carbs/insulin
...
bci_range = (basal_change_index-(round(1.0/dt)):round(0.5/dt):(basal_change_index+(round(1.0/dt))));
