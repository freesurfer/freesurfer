...
for  t=1:parms.T1/parms.dt
    ...
    % deltas are all positive
    delta_Ip_to_cells = parms.k1*Ip*parms.dt ;
    delta_glucose_to_blood = parms.k4*Gs*parms.dt ;
    delta_If_to_blood = parms.k3*If*parms.dt ;
    delta_Ip_to_fluid = parms.k2*Ip*parms.dt ;
    ...
    Gp = Gp + delta_glucose_to_blood + (-delta_Ip_to_cells*parms.k5) + parms.k6/parms.dt ;
end
