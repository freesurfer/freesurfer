...
t = (0:(T2-1))';
allOnes = ones(T2,1);
totalInsulin = (parms.k6*T2 + sum(parms.carb_grams)*parms.carb_sensitivity + parms.G0-parms.G_target)/parms.insulin_sensitivity;
...
ln1 = line([0 T2], [ parms.G_target parms.G_target]);
ln2 = line([0 T2], [parms.low_limit parms.low_limit]);
