...
%% Optimize
% Assuming the blood glucose is G = l - K*Ip, we minimize ||G-G-target||^2
K = SI*k4*OP_int;
...
%Ip = linprog(-K'*(l-G_target*allOnes), [A1; A2; A3], [b1; b2; b3], [Aeq1; Aeq2; Aeq3], [beq1; beq2; beq3], Ip_min, [], [], optimoptions('linprog', 'Algorithm', 'interior-point'));
G = l - K*Ip;
...
set(gca, 'fontsize', 16, 'fontweight', 'bold','xlim', [0 300],'ytick', [0:50:400],'ylim', [0 425]) ;
...
hold on
set(get(gca, 'children'), 'linewidth', 6)
set(gca, 'fontsize', 16, 'fontweight', 'bold','xlim', [0 300], 'ylim',[0 4.25], 'ytick', [0:.5:4.0]) ;
hold off ;
