...
prev_rms = min_rms ;
total_insulin = sum(parms.insulin) ; del_insulin = parms.basal ;
...
for iter=1:40
    ...
    if (mod(iter,10) ==0)
        ...
        prev_rms = end_rms ;
	if (pct_change < .1)
	   del_insulin = del_insulin / 2 ;
	   disp('reducing insulin delta')   ;
	   if (del_insulin < parms.basal/10)
...
set(gca, 'ytick', [100:50:300],'ylim', [0 325])
