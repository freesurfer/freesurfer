...
parms.insulin_delay = max(1,carb_delay-15) ;
...
%% Optimize
% Assuming the blood glucose is G = l - K*Ip, we minimize ||G-G_target||_2 by quadratic programming, or ||G-G_target||_1 by linear programming
K = SI*k4*OP_int;
...
hold on
set(get(gca, 'children'), 'linewidth', 6)
set(gca, 'fontsize', 16, 'fontweight', 'bold','xlim', [0 300],'ytick', [0:.5:4.0],'ylim', [0 4.25]) ;
hold off ;
