...
parms.k4 = k1 ;    % rate at which carbs are metabolized from stomach to blood (grams/min)
...
hold on
set(get(gca, 'children'), 'linewidth', 6)
set(gca, 'fontsize', 16, 'fontweight', 'bold','xlim', [0 T1],'ytick', [0:.5:6.0],'ylim', [0 6]) ;
set(hx(1), 'ticklength', [0 0])
set(hx(2), 'ticklength', [0 0])
hold off ;
