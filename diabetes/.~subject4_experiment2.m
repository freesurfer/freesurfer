...
BG0 = [42.2 54.25 57.55 83.8 112.5 144.5 158 171.5 193.5 204.5 201.5 ...
       210.5 207.5 207 204.5 203.5 195 194.5 191.5 188.5 182.5 176.5 ...
       173.5 165 164 160];
...
[foo, basal_change_index] = min(abs(basal_time*60-0));
